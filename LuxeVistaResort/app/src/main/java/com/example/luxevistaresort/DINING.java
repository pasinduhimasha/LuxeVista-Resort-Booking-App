    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonReserve.setOnClickListener(v -> {
            if (selectedDate.isEmpty()) {
                Toast.makeText(DINING.this, "Please select a date", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            fStore.collection("Reservations").add(reservation)
                    .addOnSuccessListener(documentReference -> {
                        Toast.makeText(DINING.this, "Reservation Successful!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), DINING.class));
                        finish();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(DINING.this, "Reservation Failed!", Toast.LENGTH_SHORT).show();
                    });
        });
