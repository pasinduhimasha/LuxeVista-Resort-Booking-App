...
public class Ocean_VIEW_ROOM1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ocean_view_room1);
        ...
        buttonReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedDate.isEmpty()) {
                    Toast.makeText(Ocean_VIEW_ROOM1.this, "Please select a date", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.collection("Booking")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(Ocean_VIEW_ROOM1.this, "Reservation Saved!", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Ocean_VIEW_ROOM1.this, "Failed to Save Reservation", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Ocean_VIEW_ROOM1.this, Firstscreen.class);
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Ocean_VIEW_ROOM1.this, UserDashboard.class);
                startActivity(intent);
                finish();
            }
        });
