    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedDate.isEmpty()) {
                    Toast.makeText(SINGLE_ROOM.this, "Please select a date", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.collection("Reservations")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(SINGLE_ROOM.this, "Reservation Saved!", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(SINGLE_ROOM.this, "Failed to Save Reservation", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SINGLE_ROOM.this, Firstscreen.class);
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SINGLE_ROOM.this, UserDashboard.class);
                startActivity(intent);
                finish();
            }
        });
