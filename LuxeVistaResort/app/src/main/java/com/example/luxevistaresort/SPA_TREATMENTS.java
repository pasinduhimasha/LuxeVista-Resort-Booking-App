...
public class SPA_TREATMENTS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spa_treatments);

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.spa_treatments), (v, insets) -> {
        ...
        buttonReserve.setOnClickListener(v -> {
            if (selectedDate.isEmpty()) {
                Toast.makeText(SPA_TREATMENTS.this, "Please select a date", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            fStore.collection("Reservations").add(reservation)
                    .addOnSuccessListener(documentReference -> {
                        Toast.makeText(SPA_TREATMENTS.this, "Reservation Successful!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), UserDashboard.class));
                        finish();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(SPA_TREATMENTS.this, "Reservation Failed!", Toast.LENGTH_SHORT).show();
                    });
        });
