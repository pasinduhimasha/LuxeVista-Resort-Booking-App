...
public class BEACH_TOURS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beach_tours);
        ...
        buttonReserve.setOnClickListener(v -> {
            if (selectedDate.isEmpty()) {
                Toast.makeText(BEACH_TOURS.this, "Please select a date", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            fStore.collection("Reservations").add(reservation)
                    .addOnSuccessListener(documentReference -> {
                        Toast.makeText(BEACH_TOURS.this, "Reservation Successful!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), BEACH_TOURS.class));
                        finish();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(BEACH_TOURS.this, "Reservation Failed!", Toast.LENGTH_SHORT).show();
                    });
        });
