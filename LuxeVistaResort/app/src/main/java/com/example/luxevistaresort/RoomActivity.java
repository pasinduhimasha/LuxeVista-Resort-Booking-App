    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedDate.isEmpty()) {
                    Toast.makeText(RoomActivity.this, "Please select a date", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.collection("Booking")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(RoomActivity.this, "Reservation Saved!", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(RoomActivity.this, "Failed to Save Reservation", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RoomActivity.this, Firstscreen.class);
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RoomActivity.this, UserDashboard.class);
                startActivity(intent);
                finish();
            }
        });
