...
public class OCEAN_VIEW_ROOM2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ocean_view_room2);
        ...
        buttonReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedDate.isEmpty()) {
                    Toast.makeText(OCEAN_VIEW_ROOM2.this, "Please select a date", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.collection("Booking")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    Toast.makeText(OCEAN_VIEW_ROOM2.this, "Reservation Saved!", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(OCEAN_VIEW_ROOM2.this, "Failed to Save Reservation", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OCEAN_VIEW_ROOM2.this, Firstscreen.class);
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OCEAN_VIEW_ROOM2.this, UserDashboard.class);
                startActivity(intent);
                finish();
            }
        });
